...
//		ChromeDriver driver = new ChromeDriver(options);
		...
		ImportProduct LoginUser = new ImportProduct();
		LoginUser.loginUser("admin", "admin123");
		
		readClass = new ReadClass("C:\\Users\\Dell\\Desktop\\AddProduct.xlsx");
	...
	private void fillZone(int i) throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("body > ngb-modal-window > div > div > div.modal-body > form > div:nth-child(9) > div.mb-3.col-md-6 > input")).sendKeys(readClass.getData(0, i, 7));
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("body > ngb-modal-window > div > div > div.modal-body > form > div:nth-child(10) > div.mb-3.col-md-6 > input")).sendKeys(readClass.getData(0, i, 8));
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("body > ngb-modal-window > div > div > div.modal-body > form > div:nth-child(11) > div.mb-3.col-md-6 > input")).sendKeys(readClass.getData(0, i, 9));
		Thread.sleep(1000);
		driver.findElement(By.cssSelector("body > ngb-modal-window > div > div > div.modal-body > form > div:nth-child(12) > div.mb-3.col-md-6.my-auto > select")).sendKeys(readClass.getData(0, i, 10));
		Thread.sleep(1000);
