...
//		ChromeDriver driver = new ChromeDriver(options);
		...
		ImportTerritory LoginUser = new ImportTerritory();
		LoginUser.loginUser("admin", "admin123");
		
		readClass = new ReadClass("C:\\Users\\Dell\\Desktop\\ImportTerritory.xlsx");
	...
	private void fillZone(int i) throws InterruptedException {
		...
		driver.findElement(By.cssSelector("#content-top-pagination > app-territory > div:nth-child(1) > div.d-flex.top-section > div > button")).click();
		driver.findElement(By.cssSelector("#territoryName")).sendKeys(readClass.getData(0, i, 1));
		driver.findElement(By.cssSelector("body > ngb-modal-window > div > div > div.modal-body > form > div:nth-child(2) > select")).sendKeys(readClass.getData(0, i, 0));
	...
	private void loginUser(String username, String password) throws InterruptedException {
		...
		driver.findElement(By.xpath(
				...
				.click();
		Thread.sleep(5000);
		driver.findElement(By.linkText("Territory")).click();
		Thread.sleep(5000);
	}
